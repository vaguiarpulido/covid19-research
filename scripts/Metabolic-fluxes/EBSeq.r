...
countData_entrez<-countData[rownames(countData) %in% ensembl_to_entrez$ensembl_gene_id,]

#### Run EBSeq2 by Series
source("run_ebseq.R")

### Series1
count_table<-countData_entrez[,1:6]
